...
ActiveRecord::Schema.define(version: 20160428182003) do
  ...
  add_index "article_views", ["user_id"], name: "index_article_views_on_user_id", using: :btree
  ...
  add_index "articles", ["title", "id"], name: "index_articles_on_title_and_id", unique: true, using: :btree
